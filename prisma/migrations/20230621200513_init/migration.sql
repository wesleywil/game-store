...
-- AddForeignKey
ALTER TABLE `GameMidia` ADD CONSTRAINT `GameMidia_gameId_fkey` FOREIGN KEY (`gameId`) REFERENCES `Game`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
